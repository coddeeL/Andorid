package com.example.ljdcontentprovider
...
class DatabaseProvider : ContentProvider() {
    ...
    private val authority="com.example.databatest.provider"
    ...
    override fun getType(uri: Uri)=when(uriMathcher.match(uri)) {
        peopleDir->"vnd.android.cursor.dir/vnd.com.example.databatest.provider.people"
        peopleItem->"vnd.android.cursor.Item/vnd.ccom.example.databatest.provider.people"
        else->null
    }
