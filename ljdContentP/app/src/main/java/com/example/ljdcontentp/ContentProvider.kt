...
class ContentProvider : ContentProvider() {
    ...
    private val authority="com.example.ljdcontentp.provider"
    ...
    override fun getType(uri: Uri)=when(uriMathcher.match(uri)) {
        peopleDir->"vnd.android.cursor.dir/vnd.com.example.ljdcontentp.provider.people"
        peopleItem->"vnd.android.cursor.item/vnd.com.example.ljdcontentp.provider.people"
        else->null
    }
